...
public class SwitchUnit implements Runnable{
    String address[];
    ...
    DataInputStream dis;
    String my_name;
    public SwitchUnit(String my_port,String ur_port,String my_name) {
    ...
    public static void main(String[] args) {
        ...
        SwitchUnit sc=new SwitchUnit(args[0],args[1],args[2]);
        sc.tsend.start();
         sc.tread.start();
	sc.tdata.start();
    }
